...
class NotesViewModel @Inject constructor(
    ...
    //State of values our UI will observe
    ...
    fun onEvent(event: NotesEvent) {
        when(event) {
            is NotesEvent.Order -> {
                //Compare the classes because NoteOrder classes are not data classes nor do they
                // override equals
    ...
    private fun getNotes(noteOrder: NoteOrder) {
        //When this is called, we want to cancel other coroutine jobs that are running
        getNotesJob?.cancel()
